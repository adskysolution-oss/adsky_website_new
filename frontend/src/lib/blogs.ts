...
export const blogPosts: BlogPost[] = [
  ...
  {
    id: 5,
    slug: 'how-adsky-scales-last-mile-operations',
    title: 'How AD Sky Solution Scales Last-Mile Operations Without Compromising Quality',
    excerpt:
